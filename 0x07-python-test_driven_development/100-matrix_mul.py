...
def matrix_mul(m_a, m_b):
    ...
    Args:
        m_a (list): Matrix A represented list of lists of integers or floats.
        m_b (list): Matrix B represented list of lists of integers or floats.

    Returns:
        list: The product of matrices A and B.

    Raises:
        TypeError: If m_a or m_b is not a list, or if m_a or m_b not of lists,
                   or if one element of the list of list integer or float,
